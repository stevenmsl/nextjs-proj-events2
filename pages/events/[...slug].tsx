...
/* #TA2-01
  - not ideal or possible to pre-generate all possible paths
    - so getStaticProps and  getStaticPaths are not used here
*/

/*
  - use type unions to deal with the need of returning 
    completely different objects for success or error
    cases
*/
